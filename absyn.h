...
struct AST_dec_ 
    {enum {AST_functionDec, AST_varDec, AST_typeDec} kind;
     ...
     union {AST_fundecList function;
	    ...
	    struct {S_symbol var; S_symbol typ; AST_exp init; bool escape;} var;
	    AST_nametyList type;
	  } u;
   };
...
struct AST_field_ {S_symbol name, typ; AST_pos pos; bool escape;};
