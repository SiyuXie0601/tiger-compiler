...
static void pr_field(FILE *out, AST_field v, int d);
static void pr_fieldList(FILE *out, AST_fieldList v, int d);
static void pr_expList(FILE *out, AST_expList v, int d);
static void pr_fundec(FILE *out, AST_fundec v, int d);
static void pr_fundecList(FILE *out, AST_fundecList v, int d);
...
static void pr_efield(FILE *out, AST_efield v, int d);
static void pr_efieldList(FILE *out, AST_efieldList v, int d);
